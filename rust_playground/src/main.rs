...
fn main() {
    ...
    let car1 = generics_structs_traits::Car {
        make: String::from("Toyota"),
        model: String::from("Camry"),
        year: 2019,
    };
    let car2 = generics_structs_traits::Car {
        make: String::from("Honda"),
        model: String::from("Accord"),
        year: 2018,
    };

    let car3 = generics_structs_traits::Car {
        make: String::from("Nissan"),
        model: String::from("Altima"),
        year: 2017,
    };

    let mut tuple_stuff = (1, "3", 4.0, 9, true, generics_structs_traits::Vehicle::V8);
...
fn list_contents (list_array: [&str; 6]) {
